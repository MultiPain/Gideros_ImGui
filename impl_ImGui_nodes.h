...
int SetNodeZPosition(lua_State* L);
int GetNodeZPosition(lua_State* L);
int SetGroupSize(lua_State* L);
...
int NodeHasAnyLinks(lua_State* L);
int NodeBreakLinks(lua_State* L);
int PinHasAnyLinks(lua_State* L);
int PinBreakLinks(lua_State* L);
...
int GetHoveredNode(lua_State* L);
int GetHoveredPin(lua_State* L);
int GetHoveredLink(lua_State* L);
...
int ImNodesStyleSetSelectedNodeBorderOffset(lua_State* L);
int ImNodesStyleGetSelectedNodeBorderOffset(lua_State* L);
