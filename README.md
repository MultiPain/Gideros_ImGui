...
value, isDragingFlag = ImGui:filledSliderFloat(label, mirrorFlag, value, [incStep = 1, min = 0, max = 0, formatString = "%.3f", power = 1])
value1, value2, isDragingFlag = ImGui:filledSliderFloat2(label, mirrorFlag, value1, value2, [incStep = 1, min = 0, max = 0, formatString = "%.3f", power = 1])
value1, value2, value3, isDragingFlag = ImGui:filledSliderFloat3(label, mirrorFlag, value1, value2, value3, [incStep = 1, min = 0, max = 0, formatString = "%.3f", power = 1])
value1, value2, value3, value4, isDragingFlag = ImGui:filledSliderFloat4(label, mirrorFlag, value1, value2, value3, value4, [incStep = 1, min = 0, max = 0, formatString = "%.3f", power = 1])
valueInRad, isDragingFlag = ImGui:filledSliderAngle(label, mirrorFlag, valueInRad, [min_degrees = -360, max_degrees = 360, formatString = "%.0f deg"])
value, isDragingFlag = ImGui:filledSliderInt(label, mirrorFlag, value, [incStep = 1, min = 0, max = 0, formatString = "%d"])
value1, value2, isDragingFlag = ImGui:filledSliderInt2(label, mirrorFlag, value1, value2, [incStep = 1, min = 0, max = 0, formatString = "%d"])
value1, value2, value3, isDragingFlag = ImGui:filledSliderInt3(label, mirrorFlag, value1, value2, value3, [incStep = 1, min = 0, max = 0, formatString = "%d"])
value1, value2, value3, value4, isDragingFlag = ImGui:filledSliderInt4(label, mirrorFlag, value1, value2, value3, value4, [incStep = 1, min = 0, max = 0, formatString = "%d"])
value, isDragingFlag = ImGui:filledSliderScalar(label, mirrorFlag, ImGuiDataType, value, [min = nil, max = nil, formatString = nil])
