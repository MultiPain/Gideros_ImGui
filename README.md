...
value = ImGui:getWindowBorderSize()
ImGui:setChildRounding(value)
value = ImGui:getChildRounding()
ImGui:setChildBorderSize(value)
value = ImGui:getChildBorderSize()
ImGui:setPopupRounding(value)
value = ImGui:getPopupRounding()
ImGui:setPopupBorderSize(value)
value = ImGui:getPopupBorderSize()
ImGui:setFrameRounding(value)
value = ImGui:getFrameRounding()
ImGui:setFrameBorderSize(value)
value = ImGui:getFrameBorderSize()
ImGui:setIndentSpacing(value)
value = ImGui:getIndentSpacing()
ImGui:setColumnsMinSpacing(value)
value = ImGui:getColumnsMinSpacing()
ImGui:setScrollbarSize(value)
value = ImGui:getScrollbarSize()
ImGui:setScrollbarRounding(value)
value = ImGui:getScrollbarRounding()
ImGui:setGrabMinSize(value)
value = ImGui:getGrabMinSize()
ImGui:setGrabRounding(value)
value = ImGui:getGrabRounding()
ImGui:setLogSliderDeadzone(value)
value = ImGui:getLogSliderDeadzone()
ImGui:setTabRounding(value)
value = ImGui:getTabRounding()
ImGui:setTabBorderSize(value)
value = ImGui:getTabBorderSize()
ImGui:setTabMinWidthForUnselectedCloseButton(value)
value = ImGui:getTabMinWidthForUnselectedCloseButton()
ImGui:setMouseCursorScale(value)
value = ImGui:getMouseCursorScale()
ImGui:setCurveTessellationTol(value)
value = ImGui:getCurveTessellationTol()
ImGui:setCircleSegmentMaxError(value)
value = ImGui:getCircleSegmentMaxError()
ImGui:setAntiAliasedLines(flag)
flag = ImGui:getAntiAliasedLines()
ImGui:setAntiAliasedLinesUseTex(flag)
flag = ImGui:getAntiAliasedLinesUseTex()
ImGui:setAntiAliasedFill(flag)
flag = ImGui:getAntiAliasedFill()
ImGui:setButtonTextAlign(x, y)
x, y = ImGui:getButtonTextAlign()
ImGui:setSelectableTextAlign(x, y)
x, y = ImGui:getSelectableTextAlign()
ImGui:setDisplayWindowPadding(x, y)
x, y = ImGui:getDisplayWindowPadding()
ImGui:setDisplaySafeAreaPadding(x, y)
x, y = ImGui:getDisplaySafeAreaPadding()
ImGui:setItemSpacing(x, y)
x, y = ImGui:getItemSpacing()
ImGui:setItemInnerSpacing(x, y)
x, y = ImGui:getItemInnerSpacing()
ImGui:setTouchExtraPadding(x, y)
x, y = ImGui:getTouchExtraPadding()
ImGui:setWindowPadding(x, y)
x, y = ImGui:getWindowPadding()
ImGui:setWindowMinSize(x, y)
x, y = ImGui:getWindowMinSize()
ImGui:setWindowTitleAlign(x, y)
x, y = ImGui:getWindowTitleAlign()
ImGui:setFramePadding(x, y)
x, y = ImGui:getFramePadding()
ImGui:setWindowMenuButtonPosition(ImGuiDir)
dir = ImGui:getWindowMenuButtonPosition()
ImGui:setColorButtonPosition(ImGuiDir)
dir = ImGui:getColorButtonPosition()
```
[To top](#api)
## DEFAULT STYLES 
```lua
...
flag = ImGui:ioGetMouseDrawCursor()
ImGui:ioSetMouseDrawCursor(flag)
